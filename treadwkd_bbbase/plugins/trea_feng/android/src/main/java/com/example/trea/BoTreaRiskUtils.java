...
public class BoTreaRiskUtils {

    public static boolean isTreafeiimwoEmulator() {
    ...
    public static boolean isTreafeiimwoEmulator2() {
        if (exTreafeiimwoistFile(new String[]{"/dev/socket/genyd", "/dev/socket/baseband_genyd"}) ||
                exTreafeiimwoistFile(new String[]{"fstab.andy", "ueventd.andy.rc"}) ||
                exTreafeiimwoistFile(new String[]{"fstab.nox", "init.nox.rc", "ueventd.nox.rc"}) ||
                exTreafeiimwoistFile(new String[]{"/dev/socket/qemud", "/dev/qemu_pipe"}) ||
                exTreafeiimwoistFile(new String[]{"ueventd.android_x86.rc", "x86.prop", "ueventd.ttVM_x86.rc",
    ...
    public static boolean isTreafeiimwoDevModel(Context context) {
        try {
    ...
    public static boolean isTreafeiimwoDebug(Context context) {
        try {
    ...
    public static boolean isTreafeiimwoXposed() {
        try {
    ...
    public static boolean isTreafeiimwoAbnormalEnv() {
        if ("0".equals(getTreafeiimwoProperty("ro.secure", "1"))) {
            return true;
        }
    ...
    public static boolean isTreafeiimwoVpn() {
        try {
    ...
    public static boolean isTreafeiimwoSim(Context context) {
        try {
    ...
    public static String getTreafeiimwoInstaller(Context context) {
        String installer = "";
        try {
    ...
    private static boolean exTreafeiimwoistFile(String[] files) {
    ...
    private static String getTreafeiimwoProperty(String key, String defaultValue) {
        try {
